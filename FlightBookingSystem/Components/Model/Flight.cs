...
namespace FlightBookingSystem.Components.Model
{
    internal class Flight : IEquatable<Flight?>
    {
        ...
        public int BookedSeats { get { return _bookedseats; } set { _bookedseats = value; } } // I've changed this, BookedSeatss needs to be mutable when we make reservations.
        ...
        {
            return $"{FlightId} : {Airline} : {Source} : {Destination} : {Day} : {BookedSeats} : {TotalSeats}  : {Cost}";
            /* I am not certain about this, especially the last 3 values.
             * There are 3 numbers at end, and they are delimited with a comma and not a colon = "00,169,449.00"
            */
        }
